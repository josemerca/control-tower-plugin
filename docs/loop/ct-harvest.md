# `/ct-harvest` — referencia y diseño

> Texto movido íntegro desde `plugin/commands/ct-harvest.md` (sub-issue #93). El comando conserva la invocación, la tabla de códigos de salida y un enlace a este documento.
...
**Seis cosas que este bloque nunca hace pasar por un cero:**

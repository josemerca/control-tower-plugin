...
- **Los tests que este plan añade se escriben con la vara del propio repo**: nombre en inglés y **sin comentarios**.  mide los ficheros del plugin contra , y los bloques de test de este plan que llevan comentarios explicativos o nombres en castellano lo ponen en rojo. Donde un bloque de código de este plan lleve un comentario, el comentario es para quien lee el plan y no viaja al fichero.

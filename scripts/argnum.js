...
// 0. La regla aquí es la más estrecha posible: SOLO dígitos decimales, con
// un signo opcional, sin espacios, sin exponente, sin punto, sin base
// alternativa. Cualquier otra cosa es `null` — nunca un número "parecido".
//
